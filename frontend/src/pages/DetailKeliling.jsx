...
//   const [form, setForm] = React.useState({ id: null, tanggal: '', lokasi: '', peserta: '' })
...
//   function openCreate() {
//     setForm({ id: null, tanggal: '', lokasi: '', peserta: '' })
//     setOpen(true)
//   }
...
//     e.preventDefault()
//     const payload = { tanggal: form.tanggal, lokasi: form.lokasi, peserta: Number(form.peserta) }
...
//                   <tr><td className="px-3 py-6 text-center text-slate-500" colSpan={4}>Belum ada data</td></tr>
//                 )}
//               </tbody>
//             </table>
//           </div>
